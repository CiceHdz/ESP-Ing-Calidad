...
GO
INSERT [dbo].[departamentos] ([id_depto], [nombre], [estado]) VALUES (1, N'Admon', N'A')
GO
...
GO
INSERT [dbo].[usuarios] ([ID_USUARIO], [NOMBRES], [APELLIDOS], [EMAIL], [PASSWORD], [ID_ROL], [IMAGEN], [FECHA_CREACION], [id_empleado]) VALUES (2, N'Roberto', N'Gutiérrez Dubón', N'gd19016@ues.edu.sv', N'123456', 1, N'', CAST(N'2023-10-21' AS Date), 6)
GO
INSERT [dbo].[usuarios] ([ID_USUARIO], [NOMBRES], [APELLIDOS], [EMAIL], [PASSWORD], [ID_ROL], [IMAGEN], [FECHA_CREACION], [id_empleado]) VALUES (4, N'Cicely', N'Hernández', N'cijo@ues.edu.sv', N'123456', 2, NULL, CAST(N'2023-11-01' AS Date), 8)
GO
