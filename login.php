...
if (isset($_POST['uname']) && isset($_POST['password'])) {
    ...
    if (empty($uname)) {
        ...
        $stmt = $conexion->prepare("SELECT TOP 1 id_usuario, email, password, id_rol, id_empleado, (select nombres from empleados emp where emp.id_empleado = usr.id_empleado) nombres FROM usuarios usr WHERE email='$uname' AND password='$pass'");
        $stmt->execute();
