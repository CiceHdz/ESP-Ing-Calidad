<?php
    ...
    if(session_id() == '' || !isset($_SESSION) || session_status() === PHP_SESSION_NONE) {
        session_start();
        $_SESSION["Titulo"] = "Indemnizaciones";
    }
        ...
        $(document).ready(function(){
            var dataTable = $('#datos_costeo').DataTable({
                ...
                buttons: [
                    ...
                    {
                        text: '<i class="fa fa-file-pdf" aria-hidden="true"></i> Cartas de Indemnización',
                        action: function () {
                            window.open('http://localhost/RRHH.IBD115-D/controller/planilla/indemnizaciones-pdf.php','_blank');
                        },
                ...
                "order":[],
                "ajax":{
                    url: "../../controller/planilla/obtener_registros_indem.php",
                    type: "POST"
                },
                "columnsDefs":[
                    {
