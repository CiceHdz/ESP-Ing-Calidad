        ...
        $(document).ready(function(){
            var dataTable = $('#datos_costeo').DataTable({
                ...
                buttons: [
                    ...
                    {
                        text: '<i class="fa fa-file-pdf" aria-hidden="true"></i> Boletas de pago',
                        action: function () {
                            window.open('http://localhost/RRHH.IBD115-D/controller/planilla/planilla-pdf.php','_blank');
                        },
