<?php
    if(session_id() == '' || !isset($_SESSION) || session_status() === PHP_SESSION_NONE) {
        session_start();
        $_SESSION["Titulo"] = "Áreas de Negocio";
    }
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Crear Departamentos</h5>
        ...
        <form method="POST" id="formulario" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-body">
                    <label for="nombre">Ingrese el nombre del área de negocio:</label>
        ...
        $(document).ready(function(){
            ...
            var dataTable = $('#datos_usuario').DataTable({
                ...
                initComplete: function() { 
                    ...
                    $("#botonCrear").click(function(){
                        $("#formulario")[0].reset();
                        $(".modal-title").text("Crear Área de Negocio");
                        $("#action").val("Crear");
                        $("#operacion").val("Crear");
                        $("#imagen_subida").html("");
                    });
                ...
                "order":[],
                "ajax":{
                    url: "../../controller/departamentos/obtener_registros.php",
                    type: "POST"
                },
                "columnsDefs":[
                    {
		    ...
		    if(nombre != '' && estado != '')
                {
                    $.ajax({
                        url:"../../controller/departamentos/crear.php",
                        method:'POST',
            ...
            $.ajax({
                url:"../../controller/departamentos/obtener_registro.php",
                method:"POST",
                ...
                success:function(data)
                    {
                        ...
                        $('.modal-title').text("Editar Área de Negocio");
            ...
            $(document).on('click', '.borrar', function(){
                var id_depto = $(this).attr("id");
                if(confirm("Esta seguro de borrar este registro:" + id_depto))
                {
                    $.ajax({
                        url:"../../controller/departamentos/borrar.php",
                        method:"POST",
                        data:{id_depto:id_depto},
                        success:function(data)
                        {
